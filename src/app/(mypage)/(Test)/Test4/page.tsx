...
export default function Page() {
  ...
  useEffect(() => {
    fetch('data/Corrected_Cleaned_Search_Input.json')
      .then((res) => res.json())
      .then((data) => {
        setAllPlaces(data);
  ...
  const submitValues = async () => {
    ...
    try {
      ...
      router.push('/Test2');  // Navigate to /Test2 after success
    } catch (err) {
      console.error(err);
      ...
      <main className="flex-grow p-6 space-y-6 m-auto w-[900px]">
        ...
        <div className="p-4 border border-black bg-white rounded-[10px]">
          ...
          <div className="justify-items-end mt-[10px]">
            ...
            <pre className="mt-4 p-4 bg-gray-100 rounded-[10px] text-sm">
