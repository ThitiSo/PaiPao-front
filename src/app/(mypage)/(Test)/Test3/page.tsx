...
<>
  ...
  <main className="flex-grow space-y-6 m-auto bg-[#120E1B]">
    ...
    {/* Column*/}
    <div className="flex flex-col w-[1100px]   mt-[20px] m-auto border border-[#2c1448] p-10 bg-[#120E1B] rounded-[10px]">
    ...
    <div className="relative w-[1100px]  m-auto rounded-[10px] mt-[20px] text-[25px]">
    ...
    {/* Card flex*/}
    <div className="flex justify-center  m-auto mt-[20px] w-[1100px]">
      <div className="flex flex-wrap  justify-between gap-10">

        <div className=" w-[500px] rounded-[10px] border border-[#2F2442] bg-[#20142c]">
